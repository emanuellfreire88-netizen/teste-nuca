...
function getAuthHeaders(hasBody) {
    const token = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"].getState().token;
    const headers = {};
    if (token) {
...
function handleUnauthorized() {
    const { logout, isAuthenticated } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"].getState();
    if (isAuthenticated) {
...
function LoginPage() {
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
        "LoginPage.useAuthStore[login]": (s)=>s.login
    }["LoginPage.useAuthStore[login]"]);
    // Change password state
    const [mustChangePassword, setMustChangePassword] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [changePasswordToken, setChangePasswordToken] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [changePasswordUser, setChangePasswordUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApiError"]) {
    ...
    const handleChangePassword = async (e)=>{
        ...
        try {
            ...
            if (!res.ok) {
                ...
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApiError"](data.error || "Erro ao alterar senha", res.status);
            }
...
_s(LoginPage, "bDf0aV+OGBqCebFWftE8zkL7euQ=", false, function() {
    return [
...
function AppLayout({ currentPage, onNavigate, children }) {
    _s();
    const { user, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
...
_s(AppLayout, "YGImKYi5uesmkvdzHLpVVXrehWI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"],
...
const DashboardPage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/src/components/dashboard-page.tsx [app-client] (ecmascript, next/dynamic entry, async loader)").then((m)=>({
...
_c = DashboardPage;
const SchoolsPage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/src/components/schools-page.tsx [app-client] (ecmascript, next/dynamic entry, async loader)").then((m)=>({
...
_c1 = SchoolsPage;
const StudentsPage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/src/components/students-page.tsx [app-client] (ecmascript, next/dynamic entry, async loader)").then((m)=>({
...
_c2 = StudentsPage;
const AttendancePage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/src/components/attendance-page.tsx [app-client] (ecmascript, next/dynamic entry, async loader)").then((m)=>({
...
_c3 = AttendancePage;
const UsersPage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/src/components/users-page.tsx [app-client] (ecmascript, next/dynamic entry, async loader)").then((m)=>({
            default: m.UsersPage
        })), {
    loadableGenerated: {
        modules: [
...
_c4 = UsersPage;
const LogsPage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/src/components/logs-page.tsx [app-client] (ecmascript, next/dynamic entry, async loader)").then((m)=>({
            default: m.LogsPage
        })), {
    loadableGenerated: {
        modules: [
...
_c5 = LogsPage;
const ReportsPage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/src/components/reports-page.tsx [app-client] (ecmascript, next/dynamic entry, async loader)").then((m)=>({
...
_c6 = ReportsPage;
const EventsPage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/src/components/events-page.tsx [app-client] (ecmascript, next/dynamic entry, async loader)").then((m)=>({
...
function Home() {
    _s1();
    const isAuthenticated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
        "Home.useAuthStore[isAuthenticated]": (s)=>s.isAuthenticated
    }["Home.useAuthStore[isAuthenticated]"]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$app$2d$layout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AppLayout"], {
        currentPage: currentPage,
...
_s1(Home, "c3liAKfwHovX7wlcNvjAyw8fZjY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"],
        useHydrated
    ];
...
__turbopack_context__.k.register(_c3, "AttendancePage");
__turbopack_context__.k.register(_c4, "UsersPage");
...
//# sourceMappingURL=src_c77b192c._.js.map