...
"[project]/src/app/api/support/tickets/[id]/messages/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(async (_req)=>{
        try {
            ...
            const [messages, total] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].supportMessage.findMany({
                    where: {
                        ticket_id: id
                    },
                    select: {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].supportMessage.count({
                    where: {
                        ticket_id: id
                    }
                })
...
async function POST(req, context) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(async (_req)=>{
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].supportMessage.updateMany({
                where: {
                    ticket_id: id,
                    sender_id: {
            ...
            const message = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].supportMessage.create({
                data: {
                    ticket_id: id,
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logAction"])(_req.user.userId, 'send_support_message', `Mensagem enviada no ticket ${ticket.protocol}`, _req);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message
            }, {
                status: 201
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d6578293._.js.map