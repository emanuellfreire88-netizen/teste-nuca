...
"[project]/src/app/api/support/tickets/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function generateProtocol() {
    ...
    const count = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].supportTicket.count({
        where: {
            created_at: {
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(async (req)=>{
    try {
        ...
        const [tickets, total] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].supportTicket.findMany({
                where,
                select: {
                    id: true,
                    protocol: true,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].supportTicket.count({
                where
            })
        ]);
...
const POST = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(async (req)=>{
    try {
        ...
        const ticket = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].supportTicket.create({
            data: {
                protocol,
                subject,
                status: 'open',
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logAction"])(req.user.userId, 'create_support_ticket', `Ticket criado: ${protocol} - ${subject}`, req);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ticket
        }, {
            status: 201
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8da15b27._.js.map