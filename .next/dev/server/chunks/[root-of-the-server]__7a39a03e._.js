...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(async (req)=>{
    try {
        ...
        const [schoolsWithCounts, studentStatusCounts, todayAttendance, weekAttendance, monthAttendance] = await Promise.all([
            // School list with student counts (also gives us totalSchools via .length)
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].school.findMany({
                include: {
                    _count: {
                        select: {
                            students: true
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].student.groupBy({
                by: [
                    'status'
                ],
                _count: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].attendanceRecord.groupBy({
                by: [
                    'status'
                ],
                _count: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7a39a03e._.js.map